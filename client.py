...
class CommandRegistry:
    ...
    def parse(self, command: str) -> str:
        ...
        try:
            ...
            return f"Error running commang: {e}"


registry = CommandRegistry()

@registry.register("plan")
def plan(learning_details: str) -> None:
    spec = requests.post("http://127.0.0.1:8000/plan", json={"learning_details": learning_details}).json()
    print(spec)
